...
import os
import re
from imdb_request import get_movie_json
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Slabo+27px|Work+Sans" rel="stylesheet">
    ...
    <style type="text/css" media="screen">
        ...
        .image-container .description-bg{
            position: absolute;
            top: 0;
            width: 220px;
            height: 342px;
        ...
        .image-container .description-text{
            position: absolute;
            top: -30px;
            left: 0;
            opacity: 0;
        ...
        .image-container .description-bg:hover{
            opacity: 0.8;
        }

        .image-container .description-bg:hover + .description-text{
            opacity: 1;
            top: 30px;
        }

        /* IMBD div underneath movie title */
        .imdb{
            display: block;
            margin: 0 auto;
        }
